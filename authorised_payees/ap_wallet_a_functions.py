...
def ap_make_puzzle(a_pubkey_serialized, b_pubkey_serialized):
    ...
    compiled_script = f'((c (q ((c (i (f (r (a))) (q ((c (f (a)) (c (f (a)) (c ((c (f (r (r (a)))) (f (r (r (r (a))))))) (c (q ()) (c (f (r (r (r (r (a)))))) (c (f (r (r (r (r (r (a))))))) (q (())))))))))) (q (c (c (q 53) (c (sha256 (f (r (r (r (r (r (r (a)))))))) (f (r (r (a)))) (f (r (r (r (r (r (r (r (a)))))))))) (q ()))) (c (c (q 51) (c (sha256tree (c (q 7) (c (c (q 5) (c (c (q 1) (c (sha256 (f (r (r (r (a))))) (f (r (r (r (r (a)))))) (f (r (r (r (r (r (a)))))))) (q ()))) (q ((q ()))))) (q ())))) (q (())))) (c (c (q 51) (c (f (r (r (a)))) (c (+ (f (r (r (r (r (r (a))))))) (f (r (r (r (r (r (r (r (a)))))))))) (q ())))) (q ())))))) (a)))) (c (q ((c (i (l (f (r (a)))) (q ((c (i (= (f (f (f (r (a))))) (q 51)) (q ((c (f (a)) (c (f (a)) (c (r (f (r (a)))) (c (c (f (f (r (a)))) (c (c (q 50) (c (q {a_pubkey}) (c (f (r (f (f (r (a)))))) (q ())))) (f (r (r (a)))))) (c (f (r (r (r (a))))) (c (f (r (r (r (r (a)))))) (c (+ (f (r (r (f (f (r (a))))))) (f (r (r (r (r (r (a)))))))) (q ())))))))))) (q ((c (f (a)) (c (f (a)) (c (r (f (r (a)))) (c (c (f (f (r (a)))) (f (r (r (a))))) (c (f (r (r (r (a))))) (c (f (r (r (r (r (a)))))) (c (f (r (r (r (r (r (a))))))) (q ()))))))))))) (a)))) (q (c (c (q 53) (c (sha256 (f (r (r (r (a))))) (f (r (r (r (r (a)))))) (f (r (r (r (r (r (a)))))))) (q ()))) (f (r (r (a))))))) (a)))) (a))))'
    # It is slightly more optimal to add aggsig solution by hand
    puz = f"(c (c (q 50) (c (q {b_pubkey}) (c (sha256tree (a)) (q ())))) {compiled_script})"
